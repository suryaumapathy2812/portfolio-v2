<div align="center">
    <a href="https://suryaumapathy.in"><h1 align="center">suryaumapathy.in</h1></a>
...
```sh-session
git clone https://github.com/suryaumapathy2812/portfolio-v2.git
cd portfolio-v2
```


Create a `.env` file similar to [`.env.example`](https://github.com/suryaumapathy2812/portfolio-v2/blob/main/.env.example).
